...
**3.2** (5 points) Compare the AI-generated code to your code: What's different? Does the AI's approach seem better/worse in any way? Do the AI-based _results_ differ?
