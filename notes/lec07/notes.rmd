...
.b.purple[Intuition:] 
--
 $\text{B}$ induces changes in $\text{A}$ and $\text{C}$. An observer will see $\text{A}$ change when $\text{C}$ also changes—they are associated due to their common cause.
...
```{r, bb4-plot-4, echo = FALSE, fig.height = 2.5, fig.width = 5}
# Plot the DAG
...
geom_text(
  ...
  family = "Fira Sans Medium",
  size = 8,
  color = c(purple, "white", "white", purple),
  fontface = "bold"
) +
theme_void() +
theme(
...
Notation for d-separation (in graph $G$): $\color{#6A5ACD}{\text{X} \ci_{G} \text{Y} \vert \text{Z}}$
...
$\longrightarrow$ {.purple[d-separation] .it[and] .pink[association]} .it[implies] .orange[causation].
